...
//  @Autowired // This annotation allows Spring to resolve and inject collaborating beans into your bean which means that it will automatically create an instance of ProductRepo and inject it into ProductService
  ...
  public Product findProductById(Long productId){
    return productRepo.findById(productId).orElseThrow(() -> new ProductNotFoundException("Product by id " + productId + " was not found")); // This method is used to retrieve an entity from the database by its id and if it is not found, it throws a ProductNotFoundException which was created in the exception package
  }
